...
from api_test.views import apiOverview, taskList, taskDetail, taskCreate, taskUpdate, taskDelete, example_view_new , ExampleView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('',apiOverview, name="api-overview"),

    path('home/',ExampleView.as_view(), name="home-demo"), #class base view
    path('new/home/',example_view_new, name="home-demo-next"), #decorator base view
